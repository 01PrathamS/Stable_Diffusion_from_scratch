...
from Stable_Diffusion_from_scratch.sd.attention import SelfAttention
...
class VAE_AttentionBlock(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor: 
        ...
        # (Batch_Size, channels, Height, Width) -> (Batch_Size, Features, Height * Width
        x = x.view(n, c, h * w) 
...
class VAE_ResidualBlock(nn.Module):
    ...
    def __init__(self, 
        ...
        self.conv_1 = nn.Conv2d(in_channels, 
                               ...
                               kernel_size=3, 
                               padding=1) 
        self.groupnorm_2 = nn.GroupNorm(32, 
                                        out_channels) 
